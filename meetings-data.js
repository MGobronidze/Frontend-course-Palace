...
const COURSE_MEETINGS = [
  ...
  { id: 8,  block: "html-css", type: "theory",   title: "შესავალი CSS-ში — სელექტორები და სინტაქსი", available: true, file: "js/meetings/meeting-08.js" },
  { id: 9,  block: "html-css", type: "theory",   title: "ფერები და ფონები CSS-ში", available: true, file: "js/meetings/meeting-09.js" },
  { id: 10, block: "html-css", type: "theory",   title: "CSS ბოქს მოდელი", available: true, file: "js/meetings/meeting-10.js" },
  { id: 11, block: "html-css", type: "theory",   title: "CSS Layout — position და display", available: true, file: "js/meetings/meeting-11.js" },
  { id: 12, block: "html-css", type: "theory",   title: "CSS ტიპოგრაფია", available: true, file: "js/meetings/meeting-12.js" },
  { id: 13, block: "html-css", type: "theory",   title: "CSS Flexbox I — ღერძები და განლაგება", available: true, file: "js/meetings/meeting-13.js" },
  { id: 14, block: "html-css", type: "practice", title: "CSS Flexbox II — პრაქტიკული აწყობა", available: true, file: "js/meetings/meeting-14.js" },
  { id: 15, block: "html-css", type: "theory",   title: "CSS გრიდი", available: true, file: "js/meetings/meeting-15.js" },
  { id: 16, block: "html-css", type: "theory",   title: "რესპონსივ დიზაინი — Media Queries", available: true, file: "js/meetings/meeting-16.js" },
  { id: 17, block: "html-css", type: "theory",   title: "Advanced HTML & CSS — გადასვლები და ანიმაციები", available: true, file: "js/meetings/meeting-17.js" },
  { id: 18, block: "html-css", type: "project",  title: "რეალური პროექტი: პორტფოლიოს გვერდი (HTML + CSS)", available: true, file: "js/meetings/meeting-18.js" },

  // ---------------- ბლოკი II: JavaScript (შეხვედრები 19-40) ----------------
  { id: 19, block: "javascript", type: "theory",   title: "შესავალი JavaScript-ში — ცვლადები და ოპერატორები", available: true, file: "js/meetings/meeting-19.js" },
  { id: 20, block: "javascript", type: "practice", title: "მონაცემთა ტიპები — პრაქტიკა", available: true, file: "js/meetings/meeting-20.js" },
  { id: 21, block: "javascript", type: "theory",   title: "Control Structures — if / else / switch", available: true, file: "js/meetings/meeting-21.js" },
  { id: 22, block: "javascript", type: "theory",   title: "ციკლები — for და while", available: true, file: "js/meetings/meeting-22.js" },
  { id: 23, block: "javascript", type: "revision", title: "გამეორება + მინი-პროექტი: მარტივი კალკულატორი", available: true, file: "js/meetings/meeting-23.js" },
